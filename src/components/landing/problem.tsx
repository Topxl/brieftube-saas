      ...
      <div className="mx-auto max-w-6xl px-6">
        <ScrollReveal>
          <h2 className="font-display text-center text-2xl font-bold md:text-3xl">
            You subscribe to 50+ channels.<br />
            <span className="text-muted-foreground">You can&apos;t watch them all.</span>
          </h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={150}>
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {painPoints.map((point) => (
              <Card key={point.title} className="hover:border-white/[0.12] hover:shadow-[0_12px_40px_rgba(0,0,0,0.35)] hover:-translate-y-0.5">
                <CardContent className="pt-6">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white/[0.06] backdrop-blur-sm border border-white/[0.08] text-red-500">
                    {point.icon}
                  </div>
